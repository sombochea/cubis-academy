...
export function PaymentReceipt({ payment, locale }: PaymentReceiptProps) {
  ...
  const handleCopyTxn = async () => {
    const txnId = payment.txnId || payment.id;
  ...
  return (
    <div>
      {/* Title and Print Button - Same Row */}
      <div className="flex items-center justify-between mb-4 print:hidden">
        <h2 className="text-2xl font-bold text-[#17224D]">
      ...
      <div ref={printRef}>
        ...
        <div className="print:hidden">
          <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden max-w-3xl mx-auto">
            ...
            <div className={`bg-gradient-to-r ${getStatusColor(payment.status)} p-6 text-white relative`}>
              {/* Status Badge and Enrollment ID - Top Right */}
              <div className="absolute top-4 right-4 flex flex-col items-end gap-2">
                <div className="inline-flex items-center gap-1.5 bg-white/20 backdrop-blur-sm px-2.5 py-1 rounded-md">
                ...
                {payment.enrollmentId && (
                  <div className="text-right">
                    <p className="text-white/70 text-xs mb-0.5">
                      <Trans>Enrollment ID</Trans>
                    </p>
                    <p className="font-mono font-bold text-xs">
                      {payment.enrollmentId.slice(0, 8).toUpperCase()}
                    </p>
                  </div>
                )}
              </div>
              ...
              <div className="mb-4 pr-32">
                <h1 className="text-2xl font-bold mb-1">CUBIS Academy</h1>
            ...
            <div className="p-6 bg-gradient-to-br from-gray-50 to-white">
              <div className="text-center">
                <p className="text-xs text-[#363942]/70 mb-1 uppercase tracking-wide">
                  <Trans>Amount Paid</Trans>
                </p>
                <p className="text-5xl font-bold text-[#17224D] mb-1">
            ...
            <div className="p-6 space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {payment.method && (
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-xs text-[#363942]/70 mb-0.5">
                        <Trans>Payment Method</Trans>
                      </p>
                      <p className="font-semibold text-[#17224D] text-sm capitalize">
                ...
                {payment.courseTitle && (
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="font-semibold text-[#17224D] text-sm">{payment.courseTitle}</p>
                      {payment.courseCategory && (
                        <p className="text-xs text-[#363942]/70">{payment.courseCategory}</p>
                      )}
                    </div>
                  </div>
                )}
                ...
                {payment.txnId && (
                  <button
                    ...
                    className="flex items-start gap-3 p-3 -m-3 rounded-lg hover:bg-gray-50 transition-colors group text-left"
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <p className="font-mono text-sm text-[#17224D] flex items-center gap-2">
                        {payment.txnId}
                        {copiedTxn ? (
              ...
              {/* Payment Progress (if enrollment) - More Compact */}
              {payment.enrollmentId && payment.totalAmount && payment.paidAmount && (
                <div className="mt-4 p-4 bg-gradient-to-br from-blue-50 to-cyan-50 rounded-lg border border-blue-200">
                  <h4 className="text-xs font-semibold text-[#17224D] mb-3 flex items-center gap-1.5 uppercase tracking-wide">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-bold text-[#17224D] text-sm">
                        ${Number(payment.totalAmount).toFixed(2)}
                      </span>
                    </div>

                    {/* This Payment */}
                    <div className="flex justify-between items-center p-2 bg-white rounded-lg border-2 border-blue-300">
              ...
              {payment.notes && (
                <div className="mt-4 p-3 bg-[#F4F5F7] rounded-lg">
                  <p className="text-xs font-semibold text-[#17224D] mb-1 uppercase tracking-wide">
                    <Trans>Notes</Trans>
                  </p>
              ...
              {payment.proofUrl && (
                <div className="mt-4">
                  <a
                    ...
                    className="flex items-center gap-2.5 p-3 bg-gradient-to-r from-indigo-50 to-purple-50 rounded-lg border border-indigo-200 hover:border-indigo-300 transition-colors"
                  >
                    ...
                    <div>
                      <p className="text-xs font-semibold text-[#17224D]">
            ...
            {/* Footer - More Compact */}
            <div className="p-4 bg-[#F4F5F7] border-t border-gray-200">
              ...
              {payment.enrollmentId && (
                <p className="text-xs text-[#363942]/70 text-center mt-1 font-mono">
        ...
        <div className="hidden print:block bg-white p-8">
          ...
          <div className="border-b-2 border-gray-900 pb-4 mb-6">
            <div className="flex justify-between items-start mb-4">
              ...
              <div className="text-right">
                <div className="inline-block px-3 py-1 border-2 border-gray-900 mb-2">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              {payment.enrollmentId && (
                <div>
                  <p className="text-xs text-gray-500 uppercase">Enrollment ID</p>
