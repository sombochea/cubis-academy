...
export function ApprovePaymentForm({ paymentId, locale }: ApprovePaymentFormProps) {
  ...
  const handleApprove = async () => {
    ...
    try {
      ...
      router.push(`/${locale}/admin/payments/${paymentId}`);
      router.refresh();
    } catch (err) {
  ...
  return (
    <div className="max-w-md w-full bg-white rounded-xl border border-gray-100 p-8 shadow-lg">
      ...
      <p className="text-[#363942]/70 text-center mb-6">
        <Trans>
          Are you sure you want to approve this payment? This will mark the payment as completed
          and update the student's enrollment status.
        </Trans>
      </p>
      ...
      <div className="flex flex-col gap-3">
        ...
        <Link href={`/${locale}/admin/payments/${paymentId}`}>
