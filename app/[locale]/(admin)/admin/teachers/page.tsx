...
async function TeachersTable({ locale }: { locale: string }) {
  // Parallel fetch teachers and course counts
  ...
  return <TeachersDataTable data={teachersWithCourses} locale={locale} />;
}
